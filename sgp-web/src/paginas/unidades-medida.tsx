    ...
    <LayoutPagina titulo='Unidades de Medida' lateral={
      <Button
        ...
        onClick={() => {
          ...
          setFormAberto(true);
        }}>Nova Unidade de Medida</Button>}>
      <TabelaUnidadeMedida unidadesMedida={unidadesMedida} aoEditar={handleEditar} aoExcluir={handleExcluir} />
      <FormularioUnidadeMedida aberto={formAberto} aoFechar={() => { setFormAberto(false); setUnidadeEditando(undefined); }} unidadeEditando={unidadeEditando} />
    </LayoutPagina >
  )
}
